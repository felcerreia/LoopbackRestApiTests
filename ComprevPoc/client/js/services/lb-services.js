  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Cliente#inserirClienteComEndereco
         * @methodOf lbServices.Cliente
         *
         * @description
         *
         * Insere um cliente e seus endereços atomicamente [em uma transação de banco]
         *
         * @param {Object=} parameters Request parameters.
         *
         *   This method does not accept any parameters.
         ...
         * Data properties:
         *
         *  - `dto` – `{DtoInserirCliente=}` - 
         */
        "inserirClienteComEndereco": {
          url: urlBase + "/Clientes/:inserirClienteComEndereco",
          method: "POST"
        },

        // INTERNAL. Use Endereco.pertence() instead.
        "::get::Endereco::pertence": {
          url: urlBase + "/Enderecos/:id/pertence",
          method: "GET"
        },
      }
    );
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    ...
    */
    R.modelName = "Endereco";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Endereco#pertence
         * @methodOf lbServices.Endereco
         *
         * @description
         *
         * Fetches belongsTo relation pertence.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.pertence = function() {
          ...
          var action = TargetResource["::get::Endereco::pertence"];
